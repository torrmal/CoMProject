...
})({"1UcXx":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "f16913b58cbc7ea8";
"use strict";
...
},{}],"gBQhE":[function(require,module,exports) {
...
function loadAll() {
    ...
    const camera = new _three.PerspectiveCamera(75, elContent.offsetWidth / elContent.offsetHeight, 0.1, 1000);
    ...
    const lines = [];
    let linesColors = [
        new _three.Color(0xFAAD80).multiplyScalar(0.5),
        new _three.Color(0xFF6767).multiplyScalar(0.5),
        new _three.Color(0xFF3D68).multiplyScalar(0.5),
        new _three.Color(0xA73489).multiplyScalar(0.5)
    ];
    function initLines() {
        sampler = new (0, _meshSurfaceSamplerJs.MeshSurfaceSampler)(turtle).build();
        for(let i = 0; i < 6; i++){
            sampler.sample(p1);
            const linesMesh = {
                colorIndex: i % 4,
    ...
    let turtle = null;
    new (0, _objloaderJs.OBJLoader)().load("man.obj", (obj)=>{
        turtle = obj.children[0];
        initLines();
    }, (xhr)=>console.log(xhr.loaded / xhr.total * 100 + "% loaded"), (err)=>console.error(err));
    ...
    class Sparkle extends _three.Vector3 {
        ...
        update() {
            ...
            if (this.size < this._size) this.size += this.scaleSpeed;
        }
    }
    ...
    function render(a) {
        ...
        if (sparkles.length < 40000) lines.forEach((l)=>{
            findNextVector(l);
            findNextVector(l);
            findNextVector(l);
        });
...
},{"three":"ktPTu","three/examples/jsm/loaders/OBJLoader.js":"htIhD","three/examples/jsm/math/MeshSurfaceSampler.js":"gkYaF"}]},["1UcXx","gBQhE"], "gBQhE", "parcelRequire57db")

//# sourceMappingURL=index.8cbc7ea8.js.map
